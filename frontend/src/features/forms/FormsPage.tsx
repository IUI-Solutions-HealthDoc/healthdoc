    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-4 shadow-sm flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <form onSubmit={handlePatientSearch} className="flex flex-1 gap-2">
          ...
          <button
            type="submit"
            className="rounded-xl bg-secondary px-3.5 py-2 text-xs font-semibold text-secondary-foreground hover:bg-secondary/80 transition-colors shrink-0"
          >
            Find
          </button>
        </form>
              ...
              <div className="pt-2 border-t border-border">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-muted-foreground font-mono mt-0.5">
                      {submissions.length} completed records
                    </div>
                  </div>
                </button>
              </div>
