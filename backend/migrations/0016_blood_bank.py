...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("screening_status", sa.String(30), nullable=False, server_default=sa.text("'pending'")),
        sa.Column("status", sa.String(30), nullable=False, server_default=sa.text("'available'")),
