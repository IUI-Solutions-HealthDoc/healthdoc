...
"""
from sqlalchemy import Column, ForeignKey, String, Text, DateTime, Boolean, CheckConstraint, Integer, Numeric, Date
...
class VisitNumberCounter(Base):
    """Matches migrations/versions/0025_visit_number_counters.py exactly.
    Composite PK (facility_id, counter_date) -- one row per facility per
    business day. No UUIDPk/Timestamps mixins, same as
    app.orders.models.OrderNumberCounter."""
