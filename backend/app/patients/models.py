...
class Patient(Base):
    ...
    uhid: Mapped[str | None] = mapped_column(String(30), unique=True, nullable=True)
    ...
    identity_path: Mapped[str] = mapped_column(String(30), nullable=False)
    identity_status: Mapped[str] = mapped_column(String(30), nullable=False, server_default="verified")
