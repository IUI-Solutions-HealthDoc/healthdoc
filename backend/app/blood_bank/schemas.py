...
class BloodUnitCreate(BaseModel):
    ...
    expiry_date: date
    screening_status: str = Field(default="passed", description="pending | passed | failed")
...
class BloodCrossmatchCreate(BaseModel):
    ...
    unit_id: uuid.UUID
    compatibility_result: str = Field(default="compatible", description="compatible | incompatible | conditional")
    notes: str | None = None
